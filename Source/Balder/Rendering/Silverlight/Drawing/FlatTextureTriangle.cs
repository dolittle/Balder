...
{
	public class FlatTextureTriangle : TriangleWithPerspectiveCorrection
	{
					...
					)
				{
					...
					Framebuffer[offset] =
						...
						Color.Additive(Color.Multiply(
							Color.Blend(Texture1.Pixels[intu, intv], MaterialDiffuseAsInt, Texture1Factor), DiffuseAsInt), SpecularAsInt)) |
										  Color.AlphaFull;

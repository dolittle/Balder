...
namespace Balder.Math
{
    public class BoundingObject : IBoundingObject
    {
        ...
        public float? Intersects(Ray ray)
        {
            ...
            if (IsBox) return BoundingSphere.Intersects(ray);
            return null;
        }
        ...
        public bool Intersects(BoundingSphere sphere)
        {
            ...
            if (IsBox) return BoundingSphere.Intersects(sphere);
            return false;
        }
        ...
        public void Intersects(ref BoundingSphere sphere, out bool result)
        {
            ...
            if (IsBox) BoundingSphere.Intersects(ref sphere, out result);
            result = false;
        }
        ...
        public ContainmentType Contains(BoundingBox box)
        {
            ...
            if (IsBox) return BoundingSphere.Contains(box);
        ...
        public void Contains(ref BoundingBox box, out ContainmentType result)
        {
            ...
            if (IsBox) BoundingSphere.Contains(ref box, out result);
        ...
        public ContainmentType Contains(Vector point)
        {
            ...
            if (IsBox) return BoundingSphere.Contains(point);
            return ContainmentType.DoesNotContain;
        }
        ...
        public void Contains(ref Vector point, out ContainmentType result)
        {
            ...
            if (IsBox) BoundingSphere.Contains(ref point, out result);
            result = ContainmentType.DoesNotContain;
        }
        ...
        public ContainmentType Contains(BoundingSphere sphere)
        {
            ...
            if (IsBox) return BoundingSphere.Contains(sphere);
            return ContainmentType.DoesNotContain;
        }
        ...
        public void Contains(ref BoundingSphere sphere, out ContainmentType result)
        {
            ...
            if (IsBox) BoundingSphere.Contains(ref sphere, out result);
            result = ContainmentType.DoesNotContain;
        }
        ...
        {
            if (IsSphere && boundingObject.IsSphere || !IsSet) BoundingSphere = BoundingSphere.CreateMerged(BoundingSphere??new BoundingSphere(Vector.Zero,0), boundingObject.BoundingSphere);
        }
